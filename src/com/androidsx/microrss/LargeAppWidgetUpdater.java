...
/**
 * Updater for the large-sized widget. 
 */
public class LargeAppWidgetUpdater extends AppWidgetUpdater {
  private static final String TAG = LargeAppWidgetUpdater.class.getSimpleName();
  ...
  protected String getShowNextItemActionId() {
    return ActionIds.LargeWidget.SHOW_NEXT_ITEM_ACTION;
  }

  @Override
  protected String getShowPreviousItemActionId() {
    return ActionIds.LargeWidget.SHOW_PREV_ITEM_ACTION;
  }
  
  @Override
  protected String getUpdateFeedActionId() {
    return ActionIds.LargeWidget.UPDATE_FEED_ACTION;
  }
