...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
		...
		try {
			...
			insert.bindLong(1, 2);
			insert.bindString(2, "http://feeds.mashable.com/mashable");
			insert.bindString(3, "Mashable!");
			insert.bindLong(4, 0);
			insert.executeInsert();
			...
			insert.bindLong(1, 2);
			insert.bindString(2, "http://feeds.slashgear.com/slashgear");
			insert.bindString(3, "SlashGear");
			insert.bindLong(4, 0);
			insert.executeInsert();
			...
			insert.bindLong(1, 3);
			insert.bindString(2, "http://feeds.latimes.com/LAT_Sports_Blog");
			insert.bindString(3, "LA Times Sports Blog");
			insert.bindLong(4, 0);
			insert.executeInsert();
			...
			insert.bindLong(1, 5);
			insert.bindString(2, "http://thinkprogress.org/feed/");
			insert.bindString(3, "Think Progress");
			insert.bindLong(4, 0);
			insert.executeInsert();

			insert.bindLong(1, 5);
			insert.bindString(2, "http://politicalticker.blogs.cnn.com/feed/");
			insert.bindString(3, "CNN Political Ticker");
			insert.bindLong(4, 0);
			insert.executeInsert();
			...
			insert.bindLong(1, 5);
			insert.bindString(2,
					"http://abcnews.go.com/blogs/politics/the-note/feed/");
			insert.bindString(3, "The Note");
			insert.bindLong(4, 0);
			insert.executeInsert();
			...
			insert.bindString(3, "CNN Entertainment ");
			insert.bindLong(4, 0);
			insert.executeInsert();
